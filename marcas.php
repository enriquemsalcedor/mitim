<?php
	...
	//bitacora($_SESSION['usuario'], 'Maestros', 'Solicitud de interfaz de marcas', 0, '');
	permisosUrl();
...
<html>
	<head>
	    ...
	    <title> <?php echo $sistemaactual ?> | Marcas</title> 
	    <!-- Favicon icon -->
                ...
                <div class="row">
                    <div class="col-md-12 mb-4 text-right">
                        <?php if(($nivel==1) || ($nivel==2) || ($nivel==4) || ($nivel==7)): ?>
	                        <button type="button" class="btn btn-primary btn-xs" id="nuevamarca">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="table-responsive">
                            <table id="tbmarcas" class="mdl-data-table display nowrap table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th></th>  
