<?php
	...
	//bitacora($_SESSION['usuario'], 'Maestros', 'Solicitud de interfaz de areas', 0, '');
	permisosUrl();
...
<html>
	<head>
	    ...
	    <title> <?php echo $sistemaactual ?> | Áreas</title>
	    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 mb-4 text-right">
                        <button type="button" class="btn btn-primary btn-xs" id="nuevosubambiente">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="table-responsive">
                            <table id="tbsubambientes" class="mdl-data-table display table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th></th>  
    ...
    <!-- Toastr -->
		...
		<!-- Categoría -->
	    <script src="./js/subambientes.js"></script>
