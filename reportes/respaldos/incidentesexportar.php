<?php
	...
	*/	
	...
	while($row = $result->fetch_assoc()){
		$numero = $i - 5;
		debugL("ENTRÓ EN WHILE, NÚMERO: ".$i);
	...
	debugL("STARTTIME:".$start_time."- ENDTIME:".$end_time."-" . $hours." horas, ".$minutes." minutos y ".$seconds.") segundos.","TIEMPOCARGA");
