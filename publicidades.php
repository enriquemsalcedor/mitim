...
<html>
	<head>
	    ...
	    <title> <?php echo $sistemaactual ?> | Publicidades APP</title> 
	    <!-- Favicon icon -->
                ...
                <div class="row">
                    <div class="col-md-12 mb-4 text-right">
                        <?php if(($nivel==1) || ($nivel==2) || ($nivel==4) || ($nivel==7)): ?>
	                        <button type="button" class="btn btn-primary btn-xs" id="nuevapublicidad">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="table-responsive">
                            <table id="tbpublicidades" class="mdl-data-table display nowrap table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th></th>  
    ...
    <!--**********************************
	    ...
	    ***********************************-->
	    ...
	    <script src="./js/publicidades.js"></script>
		<!--Sweetalert2-->
