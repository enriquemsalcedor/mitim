...
<html>
	<head>
	    ...
	    <title> <?php echo $sistemaactual ?>  | Prioridades</title>
	    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 mb-4 text-right">
                        <button type="button" class="btn btn-primary btn-xs" id="nuevaprioridad">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="table-responsive">
                            <table id="tbsla" class="mdl-data-table display table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th></th>  
                                        <th>Acción</th>
