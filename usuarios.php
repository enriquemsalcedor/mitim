...
<html>
	<head>
	    ...
	    <title> <?php echo $sistemaactual ?> | Usuarios</title>
        <?php echo $var_nivel ?>
               ...
               <div class="row">
                    <div class="col-xl-12">
                        <div class="table-responsive">
                            <table id="tablausuarios" class="mdl-data-table display table-striped" style="width:100%">
                                <thead>
                                    <tr>
										...
										<th id="cdepartamentos">Departamentos</th>
										<th id="cgrupos">Grupos</th>
										<?php endif; ?>
