...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
    ...
    showSwal: function(type, titulo, texto){    	
        if(type == 'basic'){
        	swal({
    	...
    	}else if(type == 'success-message-and-evidence'){
        	swal({
                title: titulo,
                text: texto,
                type: "success",
                ...
                confirmButtonText: 'Agregar evidencias?',
    ...
    showNotificationAlert: function(from, align, texto, color){
        //type = ['','info','success','warning','danger','rose','primary'];
    	$.notify({
        	icon: "notifications",
        	message: texto
