					...
					<form id="form_incidentes_mas">
						<div class="form-row">
							<div class="col-xs-12 col-sm-12 content-incidente">
								<div class="form-group label-floating">
									<label class="control-label" style="font-weight: bold;">Preventivos</label>
									<input type="hidden" id="incidentemas" name="incidentemas" disabled="disabled" class="form-control" style="font-size: 18px;font-weight: bold;color: #000000;">
							...
							<div class="col-xs-12 col-sm-4">
								<div class="form-group label-floating">
									...
									<input type="text" name="marcamas" id="marcamas" disabled class="form-control">
								</div>
							</div>
							<div class="col-xs-12 col-sm-4">
								<div class="form-group label-floating">
									<label class="control-label">Modelo</label>
									<input type="text" id="modelomas" name="modelomas" disabled class="form-control">
								</div>
							</div>
							<div class="col-xs-12 col-sm-4 content-fechacierre box-fechahoracierre">
								<div class="form-group label-floating">
									...
									<input type="text" id="fecharesolucionmas" name="fecharesolucionmas" class="form-control inc-edit">
								</div>
							</div>
						...
						<div class="card-footer">
							<div class="float-right">
								<button type="button" class="btn btn-warning btn-xs" style="float:right" onclick="cerrarDialogIncidenteMasivo();">
