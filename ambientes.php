<?php
	...
	//bitacora($_SESSION['usuario'], 'Maestros', 'Solicitud de interfaz de ubicaciones', 0, '');
	permisosUrl();
...
<head>
    ...
    <title> <?php echo $sistemaactual ?> | Ubicaciones</title>
    <?php echo $var_nivel ?>
...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 mb-4 text-right">
						<!--<button type="button" class="btn btn-primary btn-xs" id="nuevoambiente">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="table-responsive">
                            <table id="tbsitios" class="display min-w850 ">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th id="<?php echo $nivel; ?>" >Acción</th> 
                                        <th id="cnombre">Nombre</th>  
                                        <th id="cresponsables">Responsables</th>  
    ...
    ***********************************-->
    ...
    <script src="./js/ambientes.js?<?php autoVersiones(); ?>"></script>
