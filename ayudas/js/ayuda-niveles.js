...
$(document).ready(function () {
	...
	$ayuda1="El sistema de mantenimiento tiene muchas funciones, entre ellas: "+$salto1+$lista+"- Consulta de datos."+$salto1+$lista+"- Modificación de datos."+$salto1+$lista+"- Eliminación de datos."+$salto1+$lista+"- Alta/Modificación de usuarios."+$salto1+$lista+"- Eliminación de usuarios, etc.."+$salto2;

	
    $ayuda2="Para controlar quien puede realizar alguna actividad se le asigna un nivel de identificación a cada usuario en particular."+$salto2;
	...
	$ayuda4="Esto  permite la utilización de grupos de usuarios según el nivel y así, el sistema, reconoce los privilegios de cada usuario dependiendo del grupo al que pertenezca (Gerentes, Ingenieros, Administrador, etc.).";
