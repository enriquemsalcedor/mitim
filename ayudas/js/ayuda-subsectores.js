...
$(document).ready(function () {
	...
	$("#myModalLabel").text("Ayuda sobre Subsectores");	   
	$(function() {
	$elcolor="#d9ebf9";
	$salto1="<br />";
	$salto2="<br /><br />";
	...
	"En la pantalla inicial se observa un listado de todos los 'subsectores' disponibles, de que 'sector' depende y los botones para su mantenimiento: incluir nuevo 'subsector', "+
	" eliminación y modificación de los 'subsectores' existentes."+$salto2
	;
	$ayuda0_1=""+
	...
	$salto2+
	"<img class='center-block' src='imagenesAyuda/subsectores/pantallaprincipal.PNG' width='80%' /> "+$salto2
	;
	...
	"<img class='center-block' src='imagenesAyuda/subsectores/iconomenu.png'  /> "+$salto2
	+"<span class='titulo'>"+"Ejemplo del menú lateral"+"</span>"+$salto2+
	"<img class='center-block' src='imagenesAyuda/subsectores/menu-lateral.png'  /> "+$salto2;
	
	$ayuda1_1="<span class='titulo'>"+"Zona 2: MENÚ PRINCIPAL"+"</span>"+$salto1+
	"Posee las opciones generales de la pantalla de 'subsectores', a las cuales se pueden acceder haciendo clic encima de cada una de ellas."+$salto2+
	"<img class='center-block' src='imagenesAyuda/subsectores/menuprincipal.png' width='90%'  /> "+$salto2+
	"<span class='titulo'>"+"a) SUBSECTORES"+"</span>"+$salto1+
	...
	"<img class='center-block' src='imagenesAyuda/subsectores/subsectores.PNG'  />"+$salto2+
	"<span class='titulo'>"+"b) NUEVO"+"</span>"+$salto1+
	"Esta opción de un nuevo 'subsector' permite agregar un 'subsector' con los datos nombre, descripción y a que 'sector' pertenece (se selecciona de una lista con los sectores disponibles), siendo obligatorio el nombre del sector con tres caracteres o más y el subsector a que pertenece."+$salto2+
	"<img class='center-block' src='imagenesAyuda/subsectores/nuevo.png'/> "+$salto2+
	
	"<span class='titulo'>"+"FORMULARIO DE NUEVO SUBSECTOR"+"</span>"+$salto1+
	"En éste formulario introduce los datos y pulsa el botón 'Guardar' o 'Cancelar' según lo que desee hacer."+$salto2+
	"<img class='center-block' src='imagenesAyuda/subsectores/nuevosubsector.png' width='80%'/> "+$salto2+
	...
	"<img class='center-block' src='imagenesAyuda/subsectores/exportaraexcel.PNG'  />"+$salto2+
	...
	"<img class='center-block' src='imagenesAyuda/subsectores/grabarexcel.PNG' width='80%'/> "+$salto2+
	...
	"<img class='center-block' src='imagenesAyuda/subsectores/enexcel.PNG'  width='90%'/>"+$salto2
	; 
	...
	$salto2+
	"<img class='center-block' src='imagenesAyuda/subsectores/limpiarcolumnas.png' /> "+$salto2+
	...
	"<img class='center-block' src='imagenesAyuda/subsectores/numeroregistros.png'  /> "+$salto2
	; 
	...
	"<img class='center-block' src='imagenesAyuda/subsectores/limpiarcolumas2.PNG' width='80%'/>"+ $salto2;
 
	$ayuda2=$ayuda2+
 	"<span class='titulo'>"+"Zona 5: LÍNEAS DE DETALLE O DATOS"+"</span>"+$salto1+
	"Cada línea de detalle es un 'SUBSECTOR', donde en la primera columna de cada línea o fila tiene sus imágenes gráficas o iconos "+
	" de las acciones que pueden afectar a cada fila. "+
	"Un ejemplo de líneas de detalle es: "+$salto2+
	"<img class='center-block' src='imagenesAyuda/subsectores/detalles.PNG' width='80%'/>"+ $salto2+
	"En cualquier punto de una fila que se pulse doble clic permite editar los datos del 'subsector', es decir muestra un formulario "+
	"con los datos del subsector donde se hizo el doble clic para modificar los datos y guardar esa información. "
	+" Una fila de la figura anterior sería el recuadro rojo en la figura siguiente:"
	+$salto2+
	"<img class='center-block' src='imagenesAyuda/subsectores/lineadetalles.PNG' width='80%'/>"+ $salto2+
	"Si pulsamos doble clic en cualquier punto de esa zona roja mostraría el formulario siguiente:"
	+$salto2+
	"<img class='center-block' src='imagenesAyuda/subsectores/modificarsubsector.PNG' width='80%'/>"+ $salto2;
  ...
  /* $ayuda2=$ayuda2+"<span class='titulo'>"+"Zona 6: BARRA DE DESPLAZAMIENTO HORIZONTAL"+"</span>"+$salto1+
	...
	"<img class='center-block' src='imagenesAyuda/subsectores/entornodesplazamiento.PNG' />"+$salto2
	;
	$ayuda10="</p></div>";
