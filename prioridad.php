<?php
	...
	//bitacora($_SESSION['usuario'], 'Maestros', 'Solicitud de interfaz de prioridad', 0, '');
	permisosUrl();
?>
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title><?php echo $sistemaactual ?> | Prioridad</title>
        <!-- Favicon icon -->
 ...
 <!--**********************************
            ...
            <div class="container-fluid">
				<div class="row">
                    ...
                    <div class="col-md-12 mb-4 text-right barraOpc">
                        <button type="button" class="btn btn-primary btn-xs" id="listadosla">
						...
						<div class="card">
                            <div class="card-body">
								<form id="form_prioridad_ce" autocomplete="none">
									<div class="pt-4">
										<div class="form-row">
											<div class="col-xs-12 col-sm-6 col-md-6">
												<div class="form-group label-floating">
													<input type="hidden" name="idsla" id="idsla" >
													<label class="control-label" for="prioridad">Prioridad <span class="text-red">*</span>
													</label>
													<input type="text" class="form-control text" name="prioridad" id="prioridad" autocomplete="off">
												</div>
										...
										<!--	<div class="col-xs-12 col-sm-6 col-md-6">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control text" name="dias" id="dias" autocomplete="off">
												</div>
											...
											<div class="col-xs-12 col-sm-6 col-md-6">
												<div class="form-group label-floating">
													...
													<input type="text" class="form-control text" name="horas" id="horas" autocomplete="off">
												</div>
											</div>
                                    ...
                                    <button type="button" class="btn btn-primary btn-xs" id="guardar-sla" style="float:right;">
	    ...
	    ***********************************-->
	    ...
	    <script src="./js/sla-ne.js?<?php autoVersiones(); ?>"></script>
	    <!--sweetalert2-->
