...
<head>
    ...
    <title> <?php echo $sistemaactual ?> | Subtipos </title>
    <?php echo $var_nivel ?>
...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 mb-4 text-right">
						<button type="button" class="btn btn-primary btn-xs" id="btn-nuevoSubtipo">
    ...
    ***********************************-->
    ...
    <!-- Usuarios -->
    <script src="./js/subtipos-n.js?"+rand()+"" ></script> 
