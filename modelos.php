...
<html>
	<head>
	    ...
	    <title> <?php echo $sistemaactual ?> | Modelos</title>
	    <!-- Favicon icon -->
                ...
                <div class="row">
                    <div class="col-md-12 mb-4 text-right">
                        <?php if(($nivel==1) || ($nivel==2) || ($nivel==4) || ($nivel==7)): ?>
	                        <button type="button" class="btn btn-primary btn-xs" id="nuevomodelo">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="table-responsive">
                            <table id="tbmodelos" class="mdl-data-table display table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th></th>  
    ...
    <!--**********************************
	    ...
	    ***********************************-->
		...
		<script src="./js/modelos.js?<?php autoVersiones(); ?>"></script>
	</body>
</html>