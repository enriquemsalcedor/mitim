<?php
	...
	//bitacora($_SESSION['usuario'], 'Maestros', 'Solicitud de interfaz de tipos', 0, '');
	permisosUrl();
...
<html>
	<head>
	    ...
	    <title> <?php echo $sistemaactual ?> | Tipos</title> 
	    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 mb-4 text-right">
                        ...
                        <button type="button" class="btn btn-primary btn-xs" id="nuevotipo">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="table-responsive">
                            <table id="tablatipos" class="mdl-data-table display table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th></th>  
