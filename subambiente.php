...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title><?php echo $sistemaactual ?> | Área</title>
 ...
 <!--**********************************
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-4 text-right barraOpc">
                        <button type="button" class="btn btn-primary btn-xs" id="listadosubambientes">
                            ...
                            <div class="card-body">
                                <form id="form_prioridad_ce" autocomplete="none">
                                    <div class="pt-4">
                                        <div class="form-row">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <div class="form-group label-floating">
                                                    <label class="control-label" for="idambientes">Ubicación <span class="text-red">*</span></label>
                                                    <select name="idambientes" id="idambientes" class="form-control text"></select>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <div class="form-group label-floating">
                                                    <input type="hidden" name="idsubambientes" id="idsubambientes" >
                                        ...
                                        <button type="button" class="btn btn-primary btn-xs" style="float:right;" id="guardar-subambiente"><i class="fas fa-check-circle mr-2"></i>Guardar</button>
        ...
        ***********************************-->
        ...
        <script src="./js/subambientes-ne.js?<?php autoVersiones(); ?>"></script>
        <!--sweetalert2-->
