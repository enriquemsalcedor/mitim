...
if (! file_exists(__DIR__.'/../configuration_incidentescost.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_incidentescost.php');
}
...
$config = require __DIR__.'/../configuration_incidentescost.php';
