...
if (! file_exists(__DIR__.'/../configuration_activoscom.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_activoscom.php');
}
...
$config = require __DIR__.'/../configuration_activoscom.php';
