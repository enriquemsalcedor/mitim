...
if (! file_exists(__DIR__.'/../configuration_postventas.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_postventas.php');
}
...
$config = require __DIR__.'/../configuration_postventas.php';
