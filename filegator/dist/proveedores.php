...
if (! file_exists(__DIR__.'/../configuration_proveedores.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_proveedores.php');
}
...
$config = require __DIR__.'/../configuration_proveedores.php';
