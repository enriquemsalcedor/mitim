...
if (! file_exists(__DIR__.'/../configuration_postventascom.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_postventascom.php');
}
...
$config = require __DIR__.'/../configuration_postventascom.php';
