...
if (! file_exists(__DIR__.'/../configuration_preventivoscost.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_preventivoscost.php');
}
...
$config = require __DIR__.'/../configuration_preventivoscost.php';
