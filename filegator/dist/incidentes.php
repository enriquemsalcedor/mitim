...
if (! file_exists(__DIR__.'/../configuration_incidentes.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_incidentes.php');
}
...
$config = require __DIR__.'/../configuration_incidentes.php';
