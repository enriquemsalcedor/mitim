...
if (! file_exists(__DIR__.'/../configuration_preventivos.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_preventivos.php');
}
...
$config = require __DIR__.'/../configuration_preventivos.php';
