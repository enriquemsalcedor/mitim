...
if (! file_exists(__DIR__.'/../configuration_incidentestemp.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_incidentestemp.php');
}
...
$config = require __DIR__.'/../configuration_incidentestemp.php';
