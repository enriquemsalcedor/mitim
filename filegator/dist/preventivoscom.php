...
if (! file_exists(__DIR__.'/../configuration_preventivoscom.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_preventivoscom.php');
}
...
$config = require __DIR__.'/../configuration_preventivoscom.php';
