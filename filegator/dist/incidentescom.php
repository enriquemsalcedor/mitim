...
if (! file_exists(__DIR__.'/../configuration_incidentescom.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_incidentescom.php');
}
...
$config = require __DIR__.'/../configuration_incidentescom.php';
