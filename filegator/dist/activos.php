...
if (! file_exists(__DIR__.'/../configuration_activos.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_activos.php');
}
...
$config = require __DIR__.'/../configuration_activos.php';
