...
if (! file_exists(__DIR__.'/../configuration_laboratoriocom.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_laboratoriocom.php');
}
...
$config = require __DIR__.'/../configuration_laboratoriocom.php';
