...
if (! file_exists(__DIR__.'/../configuration_laboratorio.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_laboratorio.php');
}
...
$config = require __DIR__.'/../configuration_laboratorio.php';
