...
if (! file_exists(__DIR__.'/../configuration_flotascom.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_flotascom.php');
}
...
$config = require __DIR__.'/../configuration_flotascom.php';
