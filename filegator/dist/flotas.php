...
if (! file_exists(__DIR__.'/../configuration_flotas.php')) {
    copy(__DIR__.'/../configuration_sample.php', __DIR__.'/../configuration_flotas.php');
}
...
$config = require __DIR__.'/../configuration_flotas.php';
