...
<html lang=en>
  <head>
    ...
    <title>'.$title.'</title>
    '.$this->add_to_head.'
    <link href="'.$public_path.'css/toastr.min.css?'.@filemtime($public_dir.'/css/toastr.min.css').'" rel=stylesheet>
  ...
  <body>
    ...
    <div id=app></div>
    <script src="'.$public_path.'js/jquery-3.2.1.min.js?'.@filemtime($public_dir.'/js/jquery-3.2.1.min.js').'"></script>
    <script src="'.$public_path.'js/toastr.min.js?'.@filemtime($public_dir.'/js/toastr.min.js').'"></script>
