<?php
    ...
    //bitacora($_SESSION['usuario'], 'Seguridad', 'Solicitud de interfaz de departamentos', 0, '');
	permisosUrl();
?>
...
<html lang="en">
    <head>
        ...
        <title><?php echo $sistemaactual ?> | Departamentos / Grupos</title>
        <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 mb-4 text-right">
                        <button type="button" class="btn btn-primary btn-xs" id="nuevodepartamento">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="table-responsive">
                            <table id="tabladepartamentos" class="mdl-data-table display table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th id="cacción">Acción</th>
                                        <th id="cnombre">Nombre</th> 
                                        <th id="cdescripción">Descripción</th> 
                                        <th id="ctipo">Tipo</th>
                                    </tr>
                                </thead> 
                                <tbody></tbody>
    ...
    ***********************************-->
    ...
    <script src="./js/departamentos.js?<?php autoVersiones(); ?>"></script>
    <!--sweetalert2-->
