...
<html lang="en">
    <head>
        ...
        <title><?php echo $sistemaactual ?> | Estados</title>
        <!-- Favicon icon -->
        ...
        <link href="./css/style1.css?version=1.0.0.11" rel="stylesheet">
        ...
        <!-- Ajustes -->
        <link href="./css/ajustes.css?version=1.0.0.11" rel="stylesheet">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 mb-4 text-right">
                        <button type="button" class="btn btn-primary btn-xs" id="nuevoestado">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="table-responsive">
                            <table id="tbestados" class="display min-w850 ">
                                <thead>
                                    <tr>
                                        <th></th>  
                                        <th>Acción</th>
    ...
    ***********************************-->
    ...
    <!-- Usuarios -->
    <script src="./js/estados.js?<?php autoVersiones(); ?>"></script>
