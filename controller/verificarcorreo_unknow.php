		...
		if($titulo != "Sin Asunto"){
			...
			if($crearincidente == 0){ //EL INCIDENTE ESTA CREADO
				...
				*/
				...
				if($solicitante[0] != 'viva-noreply@microsoft.com' && $solicitante[0] != 'Viva-noreply@microsoft.com' && $solicitante[0] != 'no-reply@microsoft.com' && $solicitante[0] != 'mailer-daemon@googlemail.com' && $solicitante[0] != 'cortana@microsoft.com'){									
