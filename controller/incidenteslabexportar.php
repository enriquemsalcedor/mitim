<?php
	...
	//LETRA
	$objPHPExcel->getActiveSheet()->getStyle('A4:AH4')->getFont()->setBold(true)->setSize(12)->setColor($fontColor);
	$objPHPExcel->getActiveSheet()->getStyle("A4:AH4")->applyFromArray($style);
	//FONDO
	$objPHPExcel->getActiveSheet()->getStyle('A4:AH4')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID)->getStartColor()->setRGB('63b9db');
