<?php
	...
	function guardarReporte(){
		...
		if($usuario != ""){
			...
			if($result == true){
				...
				//BITACORA
				bitacora($_SESSION['usuario'], "Preventivos", "Se ha guardado el reporte de servicio del preventivo  #".$idincidente, $idincidente, $query);
				echo 1;
			}else{
				echo 0;
			}
	...
	function editarReporte(){
		...
		if($result == true){
			...
			//BITACORA
			bitacora($_SESSION['usuario'], "Preventivos", "Se ha editado el reporte de servicio del preventivo  #".$idincidente, $idincidente, $query);
			echo true;
		}else{
			echo false;
		} 
	...
	function guardarFechasTemp(){
		...
		if($mysqli->query($query)){
			$id = $mysqli->insert_id;
			//BITACORA
			//bitacora($_SESSION['usuario'], "Preventivos", "Se ha editado el reporte de servicio del preventivo #".$incidente, $incidente, $queryI);
			echo true;
		}else{
			echo false;
		} 
