...
//		var idproveedoresf 		= $("#idproveedoresf").val().join();
	...
	//	var idproveedoresf 	= $("#idproveedoresf").val().join();
		...
		//CATEGORIAS
		$.get( "controller/combosback.php?oper=categorias", { tipo: "preventivos", idproyectos: idproyectosf }, function(result){ 
			$("#categoriaf").empty();
			$("#categoriaf").append(result);
			$("#categoriaf").val(idcategoriaf.split(',')).trigger("change");
			//SUBCATEGORIAS
		...
		success: function (response) {
			...
			if (response.data!="") {
				...
				$.when( $('#idproyectosf').triggerHandler('change') ).then(function( data, textStatus, jqXHR ) {
					$.get( "controller/combosback.php?oper=categorias", { tipo: "preventivos", idproyectos: obj.idproyectosf }, function(result){ 
						$("#categoriaf").empty();
						$("#categoriaf").append(result);
					...
					//ESTADOS
					$.get( "controller/combosback.php?oper=estadosfiltrosmasivos", {idproyectos: obj.idproyectosf, tipo:"preventivo" }, function(result){ 
						$("#estadof").empty();
						$("#estadof").append(result);
