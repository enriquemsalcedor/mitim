...
function cargarDatosSop(unidad) {
	var formatNumber = {
	...
	$.ajax({
		...
		xvalor = data.rows[0]['ordenes'];
		total  = data.rows[0]['ordenes'];
		/*$("#txtTotalSoporte").circliful({
			animationStep: 5,
			foregroundBorderWidth: 15,
			backgroundBorderWidth: 25,
			percent: (xvalor * 100 / total).toFixed(1),
			halfCircle: 1, decimals: 1
        });*/
		xvalor = data.rows[0]['totalincidentes'];
		$("#txtIncidentes").circliful({
			animationStep: 5,
			foregroundBorderWidth: 15,
			backgroundBorderWidth: 25,
			percent: ((total > 0) ? (xvalor * 100 / total).toFixed(1) : 0),
			halfCircle: 1, decimals: 1
        });
		$("#txtNIncidentes").html('<strong>' + xvalor + '<br/>Incidentes</strong>');
		total = data.rows[0]['totalincidentes'];
		xvalor = data.rows[0]['totalincidentesres'];
		$("#txtIncidentesResueltos").circliful({
			animationStep: 5,
			foregroundBorderWidth: 15,
			backgroundBorderWidth: 25,
			percent: ((total > 0) ? (xvalor * 100 / total).toFixed(1) : 0),
		...
		$("#txtNIncidentesResueltos").html('<strong>' + xvalor + '<br/>Resueltos</strong>');
		xvalor = data.rows[0]['totalincidentespen'];
		$("#txtIncidentesPendientes").circliful({
			animationStep: 5,
			foregroundBorderWidth: 15,
			backgroundBorderWidth: 25,
			percent: ((total > 0) ? (xvalor * 100 / total).toFixed(1) : 0),
		...
		$("#txtNIncidentesPendientes").html('<strong>' + xvalor + '<br/>Pendientes</strong>');
		xvalor = data.rows[0]['totalprev'];
		$("#txtPreventivos").circliful({
			animationStep: 5,
			foregroundBorderWidth: 15,
			backgroundBorderWidth: 25,
			percent: ((total > 0) ? (xvalor * 100 / total).toFixed(1) : 0),
		...
		total = data.rows[0]['totalprev'];
		$("#txtNPreventivos").html('<strong>' + xvalor + '<br/>Preventivos</strong>');
		xvalor = data.rows[0]['totalprevres'];
		$("#txtPreventivosRealizados").circliful({
			animationStep: 5,
			foregroundBorderWidth: 15,
			backgroundBorderWidth: 25,
			percent: ((total > 0) ? (xvalor * 100 / total).toFixed(1) : 0),
		...
		$("#txtNPreventivosRealizados").html('<strong>' + xvalor + '<br/>Realizados</strong>');
		xvalor = data.rows[0]['totalprevpen'];
		console.log(xvalor);
		$("#txtPreventivosPendientes").circliful({
			animationStep: 5,
			foregroundBorderWidth: 15,
			backgroundBorderWidth: 25,
			percent: ((total > 0) ? (xvalor * 100 / total).toFixed(1) : 0),
		...
		$("#txtNPreventivosPendientes").html('<strong>' + xvalor + '<br/>Pendientes</strong>');
...
function cargarDatos(unidad) {
	...
	$.ajax({
		...
		xvalor = buscarValor('Angiograma', xano, data);
		$("#txtAg").circliful({
			animationStep: 5,
			foregroundBorderWidth: 15,
			backgroundBorderWidth: 25,
...
function tablaPendientes(unidad) {
	...
	var urlPendientes = 'controller/dashboardback.php?opcion=PENDIENTES&unidad=' + unidad +'&agno='+agno+'&mes='+mes;
...
function tablaRadiologos(unidad) {
	var agno = $("#filtro-desde").val();
	var mes = $("#filtro-hasta").val();
	var urlRadiologos = 'controller/dashboardback.php?opcion=RADIOLOGOS&unidad=' + unidad +'&agno='+agno+'&mes='+mes;
...
function tablaTIncidentes(unidad) {
	var agno = $("#filtro-desde").val();
	var mes = $("#filtro-hasta").val();
	var urlTIncidentes = 'controller/dashboardback.php?opcion=TINCIDENTES&unidad=' + unidad +'&agno='+$("#filtro-desde").val()+'&mes='+$("#filtro-hasta").val();
...
function tablaIncidentes(unidad) {
	var urlIncidentes = 'controller/dashboardback.php?opcion=INCIDENTES&unidad=' + unidad +'&agno='+$("#filtro-desde").val()+'&mes='+$("#filtro-hasta").val();
...
function tablaHistorial(unidad) {
	var urlHistorial = 'controller/dashboardback.php?opcion=HISTORIAL&unidad=' + unidad +'&agno='+$("#filtro-desde").val()+'&mes='+$("#filtro-hasta").val();
...
function categorias(unidad) {
	$.ajax({
		...
		for (i=0; i<data.length; i++) {
			arrCategorias.push(data[i].categoria);
			arrC.push(Number(data[i].cantidad));
		}
		arrCategorias.reverse();
		arrC.reverse();
		var gwidth = $("#tab-graficos-col2").width() * 0.98;
		var options = {
			chart: {
				renderTo: 'ct-tendcategorias',
				type: 'bar',
				width: gwidth,
				height: 350
			},
...
function actualizarTablas(unidad) {
	...
	var urlTecnicos = 'controller/dashboardback.php?opcion=TECNICOS&unidad=' + unidad +'&agno='+$("#filtro-desde").val()+'&mes='+$("#filtro-hasta").val();
...
function prevcorr(unidad) {
	$.ajax({
		...
		var gwidth = $("#tab-graficos-col1").width() * 1;
		var options = {
			chart: {
				renderTo: 'ct-tendcategorias1',
				type: 'spline',
				width: gwidth,
				height: 160
			},
