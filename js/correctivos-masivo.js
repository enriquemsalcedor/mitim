function cargarCombosMas(){
	...
	*/
	...
	$("#idclientesmas").change(function(e,data){
		...
		//SITIOS
		/*
		$.get( "controller/combosback.php?oper=sitiosclientes&idproyectos="+idproyectos, {  }, function(result){ 
			$("#unidadejecutoramas").empty();
			$("#unidadejecutoramas").append(result);
		});*/
	});
	...
	$("#idproyectosmas").change(function(e,data){
		...
		//ESTADOS
		$.get( "controller/combosback.php?oper=estados", { idproyectos: idproyectos, tipo:"incidente" }, function(result){ 
			$("#estadomas").empty();
	...
	$("#iddepartamentosmas").change(function(e,data){
		...
		$.get( "controller/combosback.php?oper=usuariosDep&iddepartamentos="+iddepartamentosmas, { nivel:"2,3" }, function(result){ 
			$("#asignadoamas").empty();
			$("#asignadoamas").append(result);
		});
	});
	...
	$("#idproyectosmas").change(function(e,data){
		var idproyectos = $("#idproyectosmas option:selected").val();	
		$.get( "controller/combosback.php?oper=categorias&tipo=correctivos&idproyectos="+idproyectos, {  }, function(result){ 
			$("#categoriamas").empty();
	...
	$("#categoriamas").change(function(e,data){
		...
		$.get( "controller/combosback.php?oper=subcategorias&idcategoria="+idcategoria, { idproyectos: idproyectos}, function(result){ 
