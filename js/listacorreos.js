jQuery(function($) {
	var grid_selector = "#grid-correos";
	var pager_selector = "#pager-correos";	
	...
	jQuery(grid_selector).jqGrid({
		//data: grid_data,
		//datatype: "local",
		url:'controller/listacorreosback.php?oper=correos',
		datatype: "json",
		height: "auto",
		colNames: ['','#','Nombre','Correo','Cargo'],
		colModel: [
			...
			{ name: 'correo', width: 150, editable: true, align: "left", editrules: {email: true, required: true}, formoptions:{rowpos: 2, colpos: 1} },
			{ name: 'cargo', width: 80, editable: true, align: "left", formoptions:{rowpos: 3, colpos: 1} }
		],
		autowidth: true,
		viewrecords : true,
		rowNum:10,
		...
		editurl: "controller/listacorreosback.php",//nothing is saved
	...
	jQuery(grid_selector).jqGrid('navGrid',pager_selector,
		...
		}, 
        {
			...
			beforeShowForm : function(e) {							
				...
				form.closest('.ui-jqdialog').find('.ui-jqdialog-titlebar').wrapInner('<div class="widget-header" />')
				//CORREO
				var $tr = $("#tr_correo"), // 'name' is the column name
			...
			afterComplete: function (response, postdata) {
				...
				if(response.responseText == '1'){
					...
					demo.showSwal('error-message','ERROR!','El Correo ya existe');
				}else{
					//alert('Proveedor Agregado Exitosamente');
					demo.showSwal('success-message','Buen trabajo!','Correo Agregado Exitosamente');
				}
		    }
        },
        {}, // del options
	...
	*/
	...
	$("li#mnuListaCorreos").addClass("active");
});
