<?php
	...
	//bitacora($_SESSION['usuario'], 'Subcategorías', 'Solicitud de interfaz de subcategorías', 0, '');
	permisosUrl();
...
<html>
	<head>
	    ...
	    <title> <?php echo $sistemaactual ?> | Subcategorías</title> 
	    <!-- Favicon icon -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="table-responsive">
                            <table id="tablasubcategorias" class="mdl-data-table display nowrap table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th></th>  
                                        <th id="<?php echo $nivel; ?>" >Acción</th>
										<th id="cnombre">Nombre</th> 
										<th id="ccategoría">Categorías</th>  
                                    </tr>
                                </thead> 
                                <tbody></tbody>
                            </table>
