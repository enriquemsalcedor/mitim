<?php
  ...
  //capurando el tipo de metodo                
	...
	function notificarCEstado($incidente,$notificar,$accion,$estadoold,$estadonew,$usuario,$user_id,$user_nivel){
		...
		if($estadonew == 13){
			$mensaje .= "<p style='padding-left: 30px;width:100%;'>El correctivo ha sido asignado a: ".$nasignadoa."</p>";
	...
	function notificarCAsignadoa($incidente,$notificar,$accion,$asignadoaInc,$asignadoa){
		...
		//MENSAJE 
		$mensaje = "<div style='padding: 30px;font-family: arial,sans-serif;'>
					<p style='font-size: 22px;width:100%;'>El correctivo #".$incidente." ha sido modificado de Asignado: ".$asignadoaant." a: ".$asignadoanue."</p>";
