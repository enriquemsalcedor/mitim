<?php
	...
	function validarGenerarReporte(){
		...
		if($row = $result->fetch_assoc()){    
			...
			if($departamento == ""){
				...
				echo json_encode(array(
                    'error' => true,
                    'msg'   => "Debe grab ar el campo Fecha de firma del Cliente"
                ));
			}elseif($estadoactivo == ""){
				echo json_encode(array(
                    'error' => true,
	...
	function guardarReporte(){
		...
		if($usuario != ""){
			...
			if($result == true){
				...
				//BITACORA
				bitacora($_SESSION['usuario'], "Incidentes", "Se ha guardado el reporte de servicio del preventivo  #".$idincidente, $idincidente, $query);
				echo 1;
			}else{
				echo 0;
			}
	...
	function editarReporte(){
		...
		if($result == true){
			...
			//BITACORA
			bitacora($_SESSION['usuario'], "Incidentes", "Se ha editado el reporte de servicio del preventivo  #".$idincidente, $idincidente, $query);
			echo true;
		}else{
			echo false;
		} 
	...
	/*-CONSULTAR-GENERAR-REPORTE-ESTATUS-UNO-------------------------------------------------------------------------------*/
